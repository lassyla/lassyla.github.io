    ...
    return (
        ...
        <br></br>
            ...
            <Switch>
              ...
              <Route path={process.env.PUBLIC_URL + '/blendertools'} component={() => <Project link="blendertools"/>} />
              ...
              <Route path={process.env.PUBLIC_URL + '/projects'} component={() => <Gallery current="projects"/>} />
